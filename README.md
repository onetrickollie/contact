[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/3q-bPX0U)
# Laboratory 3
...
1. Make a copy of this Github repository on your computer using the `git` and `clone` commands that you will input to the terminal. The commands take a URL as a parameter to specify where it can get a copy of the repository. You can find the URL by clicking on the green *Clone or download* button at the top right part of this page. Copy the URL and replace the example text shown below. Note that `username` should be replaced with your own Github username. When you hit <kbd>Enter</kbd> it will ask you to provide your Github username and token. Once done, you will have a copy of the repository on your computer.
    ```
    git clone https://github.com/CSUF-CPSC223P-achaudhari/lab-03.git
    ```
...
1. Run the unit testing program to ensure that your program runs as expected. There 7 test cases in total, run the commands that are mentioned below and run all the testcases separately. Once you pass your test cases separately, you can submit your assignment.
...
NOTE: ONLY 2 COMMITS ARE ALLOWED ON GITHUB CLASSROOM, ONE SHOULD BE FOR TESTING AND OTHER COMMIT SHOULD BE YOUR FINAL ANSWER AND I WILL BE GRADING BASED ON THE FINAL ANSWER. MORE THAN 2 COMMITS CAN LEAD TO DEDUCTION IN POINTS. (2 POINTS DEDUCTED PER TEST CASE FOR 1 EXTRA COMMIT)
